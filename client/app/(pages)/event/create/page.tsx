    ...
    <div className="w-full h-full bg-[url('/background.png')]">
      ...
      <div className="flex items-center justify-center h-screen">
        <form
          ...
          className="w-[900px] h-[670px] bg-white p-[60px] drop-shadow-lg rounded-lg"
        >
          ...
          <div className="flex flex-wrap space-x-10 mb-5">
            <div className="w-1/3 flex-1">
              ...
              <div className="relative">
                ...
                <input
                  type="date"
                  className="mb-3 text-sm rounded-lg border focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5"
              ...
              <div className="relative">
                <div className="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
                  ...
                  >
                    <path
                      fill="currentColor"
                      d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0M1.5 8a6.5 6.5 0 1 0 13 0a6.5 6.5 0 0 0-13 0m7-3.25v2.992l2.028.812a.75.75 0 0 1-.557 1.392l-2.5-1A.75.75 0 0 1 7 8.25v-3.5a.75.75 0 0 1 1.5 0"
                    />
                  </svg>
                </div>
                <input
            ...
            {error && (
              <div className="mb-5 text-orange-500 text-sm">{error}</div>
            )}
          </div>
          ...
          <div className="flex flex-wrap space-x-20 mx-10 mb-5">
            <div className="w-1/2 flex-1">
              ...
              <input
                className="mb-3 appearance-none block w-full border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                id="grid-city"
                type="text"
              ...
              <div className="relative">
                <label className="inline-flex items-center cursor-pointer">
                  ...
                  <span className="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">
                    Switch to allow others to join waitlist
                  </span>
                </label>
              </div>
            </div>
          ...
          <div className="flex justify-center">
            <button
              type="submit"
              className="text-white bg-[#0055a2] focus:ring-4 focus:ring-blue-300 font-bold rounded-lg text-m px-5 py-2.5"
            >
              Create Event
            </button>
          </div>
