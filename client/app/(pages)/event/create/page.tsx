    ...
    <div className="w-full h-full bg-[url('/background.png')]">
      ...
      <div className="flex items-center justify-center h-screen">
        ...
        >
          ...
          <div className="flex flex-wrap space-x-10 mb-5">
            ...
            <div className="w-1/2 flex-1">
              ...
              <input
                ...
                className="mb-3 appearance-none block w-full border border-gray-400 rounded py-2 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                type="number"
          ...
          <button
            type="submit"
            className="text-white bg-[#0055a2] focus:ring-4 focus:ring-blue-300 font-bold rounded-lg text-m px-5 py-2.5 mx-auto mt-5 block"
          >
            Create Event
          </button>
        </form>
