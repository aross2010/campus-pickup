      ...
      <div className="w-full">
        <div style={{ position: 'relative', width: '100%', height: '450px' }}>
          ...
          <div className="w-full absolute top-0 left-0 text-center mt-10">
            <h1 className="text-4xl mt-20 font-bold text-white text-center">Your Next Match Starts Here</h1>
            <p className="text-sm mt-5 text-gray-100/60 text-center">Play a sport you love or discover a new one</p>
          </div>
          <button className="absolute bottom-[150px] left-1/2 -translate-x-1/2 text-white font-bold rounded-md px-4 py-2 bg-gradient-to-r from-[#e5a823] to-[#e57a23]">
            Create a new game
          </button>
        </div>
